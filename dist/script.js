...
var modals = function modals() {
  ...
  bindModal('.popup_calc_btn', '.popup_calc', '.popup .popup_calc_close');
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var tagActiveClassAdd = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active', 'a');
